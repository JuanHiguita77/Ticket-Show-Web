...
class CreateUsersDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { email: { required: true, type: () => String }, password: { required: true, type: () => String }, username: { required: false, type: () => String }, rolId: { required: false, type: () => Number } };
    }
}
...
], CreateUsersDto.prototype, "rolId", void 0);
